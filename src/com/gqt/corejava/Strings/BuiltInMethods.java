...
public class BuiltInMethods {
	...
	public static void main(String[] args) {
		...
		//2.charAt()
		char c = str.charAt(3);//it will provide the character at the specified position
		System.out.println("The character at 3th position= "+c);
		...
		//4.contains()
		boolean res1=str.contains("Ramesh");//it will check if the substring is present in the main string
		System.out.println(res1);
	    res1=str.contains("Umesh");//it will check if the substring is present in the main string
		System.out.println(res1);
		...
		res3=str.startsWith("Pachin");//it will check if substring present at the start of the main string
        System.out.println(res3);
		...
		//9.indexOf()
		int index1=str.indexOf('T');//it will provide the index of the specified character in the main string
		...
		res5=str2.isEmpty();//checks if the string is empty
		System.out.println(res4);
		res4=str3.isEmpty();//checks if the string is empty
		System.out.println(res4);
